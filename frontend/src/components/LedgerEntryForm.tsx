...
import {
  ...
  GetLedgerDataDocument as GET_LEDGER_DATA,
      ...
      await addLedgerEntry({
        variables: {
          ...
          input: {
            ...
            description,
            reputationChange:
              reputationChange === '' ? undefined : parseNumericInput(reputationChange),
  ...
  return (
    <div className="ledger-form-container">
      ...
      <h3 className="zone-header" style={{ margin: '0 0 10px 0' }}>
        RECORD SP TRANSACTION
      </h3>
      <form onSubmit={handleSubmit} className="flex-col flex-gap-10">
        <div className="flex-col flex-gap-5">
          <div className="input-group flex-col">
            <label htmlFor="description" className="restricted-text sm-text mb-5">
              DESCRIPTION
            </label>
            <div
          ...
          <div className="grid-2-col flex-gap-20">
            <div className="input-group flex-col">
              <label htmlFor="amount" className="restricted-text sm-text mb-5">
                SUPPORT POINTS
              </label>
              <div
                className={`status-bar theme-green ${isInputInvalid(amount) ? 'invalid' : ''}`}
                style={{
                  padding: '0 5px',
                  display: 'flex',
                  alignItems: 'center',
            ...
            <div className="input-group flex-col">
              <label htmlFor="reputationChange" className="restricted-text sm-text mb-5">
                REPUTATION Δ
              </label>
              <div
                className={`status-bar theme-green ${isInputInvalid(reputationChange) ? 'invalid' : ''}`}
                style={{
                  padding: '0 5px',
                  display: 'flex',
                  alignItems: 'center',
          ...
          <div className="grid-2-col flex-gap-20">
            <div className="input-group flex-col">
              <label htmlFor="campaignName" className="restricted-text sm-text mb-5">
                THEATER
              </label>
              <div
                className="status-bar theme-green"
            ...
            <div className="input-group flex-col">
              <label htmlFor="monthIndex" className="restricted-text sm-text mb-5">
                MONTH INDEX
              </label>
              <div
                className="status-bar theme-green"
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    setMonthIndex(e.target.value === '' ? undefined : parseInt(e.target.value))
                  }
        ...
        <div className="flex flex-between items-center mt-5">
          <button
            ...
            disabled={
              loading ||
              isInputInvalid(amount) ||
              amount === '' ||
              amount === '-' ||
              isInputInvalid(reputationChange) ||
              reputationChange === '-'
            }
