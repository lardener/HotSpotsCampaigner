...
import {
  HirePilotDocument as HIRE_PILOT,
  UpdatePilotDocument as UPDATE_PILOT,
...
export const PilotEditor: React.FC<PilotEditorProps> = ({
  ...
  return (
    <div className="pilot-editor-container theme-amber">
      ...
      <div
        className="pilot-card-form terminal-overlay-panel"
        style={{
          zIndex: 10001,
          maxWidth: '850px',
          width: '95%',
      ...
      >
            ...
            <button
              ...
              title={
                hasSkillsDiffError
                  ...
                  : availableSP !== undefined && availableSP < hiringPrice
                    ? `INSUFFICIENT FUNDS: ${availableSP} SP AVAILABLE`
                    : `Hire pilot for ${hiringPrice} SP and record transaction`
              }
            >
          ...
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            {mode === 'edit' && trainingCost !== 0 && (
              <button
                ...
                disabled={
                  isSaving ||
                  (trainingCost > 0 && availableSP !== undefined && availableSP < trainingCost) ||
                  hasSkillsDiffError
                }
                style={{ padding: '2px 8px', fontSize: '0.8rem' }}
                title={
                  hasSkillsDiffError
                    ? 'GUNNERY AND PILOTING SKILL CANNOT DIFFER BY MORE THAN 2 POINTS.'
                    : trainingCost > 0
                      ? `Commit training for ${trainingCost} SP`
                      : `Process training adjustment/refund for ${Math.abs(trainingCost)} SP`
                }
              >
                {isSaving
                  ? '...'
        ...
        <div
          className="pilot-editor-scroll-area"
          style={{
        ...
        >
          <div className="pilot-card-body">
            {hasSkillsDiffError && (
              <div
                className="validation-error-banner mb-10"
                style={{
                  color: 'var(--terminal-red, #ff3333)',
                  fontWeight: 'bold',
                  fontSize: '0.85rem',
                  border: '1px solid var(--terminal-red, #ff3333)',
                  padding: '8px 12px',
            ...
            <div className="flex-col flex-gap-5 mb-10">
              ...
              <div className="input-group flex items-center">
                ...
                >
                  ...
                  >
                    {[0, 1, 2, 3, 4, 5, 6].map((v) => (
                      // Changed to display 'FATAL' for 6 wounds
              ...
              <div className="input-group flex items-center mb-10">
                <label
                  htmlFor="pilot-edge-ability-description"
                  className="restricted-text sm-text"
                  style={{ minWidth: '160px' }}
                >
                  EDGE ABILITY
            ...
            <div className="flex flex-gap-10 mb-10">
              {[
                ...
                <div
                  key={s.label}
                  className="tactical-panel sm-text"
                  style={{ padding: '5px 15px', textAlign: 'center', minWidth: '75px' }}
                >
                  <div
                    className="restricted-text"
                    style={{ fontSize: '0.55rem', opacity: 0.7, marginBottom: '2px' }}
                  >
                    {s.label}
                  </div>
                  <div className="terminal-text" style={{ fontSize: '1.2rem' }}>
                    {s.val}
                  </div>
                </div>
              ))}
            ...
            <div className="pilot-skills-section">
              <div className="flex-between flex-gap-10">
                <div className="skill-box flex items-center">
                  <label
                    htmlFor="pilot-total-sp-earned"
                    className="restricted-text xs-text mr-10"
                ...
                <div className="skill-box flex items-center">
                  <label
                    htmlFor="pilot-gunnery-sp-earned"
                    className="restricted-text xs-text mr-10"
                    style={{ whiteSpace: 'nowrap' }}
                  >
                    GUNNERY
                ...
                <div className="skill-box flex items-center">
                  <label
                    htmlFor="pilot-piloting-sp-earned"
                    className="restricted-text xs-text mr-10"
                    style={{ whiteSpace: 'nowrap' }}
                  >
                    PILOTING
                ...
                <div className="skill-box flex items-center">
                  <label
                    htmlFor="pilot-edge-tokens-sp-earned"
                    className="restricted-text xs-text mr-10"
                    style={{ whiteSpace: 'nowrap' }}
                  >
                    EDGE TOK
                ...
                <div className="skill-box flex items-center">
                  <label
                    htmlFor="pilot-edge-ability-sp-earned"
                    className="restricted-text xs-text mr-10"
                    style={{ whiteSpace: 'nowrap' }}
                  >
                    EDGE ABIL
            ...
            <div className="mt-5">
              <details
                className="tactical-panel sm-text"
                style={{ padding: '8px', backgroundColor: 'rgba(0,0,0,0.2)' }}
              >
                <summary className="restricted-text cursor-pointer" style={{ fontSize: '0.65rem' }}>
                  VIEW SP THRESHOLD REFERENCE DATA
                </summary>
                <div className="grid-4-col mt-10 flex-gap-20">
                  {[
                    { title: 'GUNNERY', data: gunneryThresholds },
                    { title: 'PILOTING', data: pilotingThresholds },
                    { title: 'EDGE TOK', data: edgeTokensThresholds },
                    { title: 'EDGE ABIL', data: edgeAbilityThresholds },
                  ].map((table) => (
                    <div key={table.title}>
          ...
          <footer
            className="pilot-card-footer overlay-body"
            style={{
              marginTop: '5px',
              paddingTop: '5px',
