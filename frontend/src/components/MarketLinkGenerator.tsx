...
export const MarketLinkGenerator: React.FC<MarketLinkGeneratorProps> = ({ campaignId }) => {
    ...
    const [genRandomPilotLink] = useMutation<GenerateRandomPilotLinkData>(GENERATE_RANDOM_PILOT_LINK_MUTATION);
    ...
    return (
        <div className="market-link-generator" style={{
            marginTop: '20px', padding: '15px', border: '1px solid var(--terminal-amber)',
            backgroundColor: 'rgba(0,0,0,0.4)', color: 'var(--terminal-amber)',
            fontFamily: 'monospace', display: 'flex', flexDirection: 'column', gap: '15px'
        }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                    <input
                        ...
                        placeholder="https://..."
                        style={{ flex: 1, backgroundColor: 'black', color: 'var(--terminal-amber)', border: '1px solid var(--terminal-amber)', padding: '5px' }}
                    />
                    <button className="mode-btn theme-amber" style={{ fontSize: '0.6rem' }} onClick={handleGenerateUnitLink}>[ GENERATE ]</button>
                </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                    <input
                        ...
                        style={{ flex: 1, backgroundColor: 'black', color: 'var(--terminal-amber)', border: '1px solid var(--terminal-amber)', padding: '5px' }}
                    />
                    <button className="mode-btn theme-amber" style={{ fontSize: '0.6rem' }} onClick={handleGeneratePilotLink}>[ GENERATE ]</button>
                </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                    <select
                        ...
                        style={{ backgroundColor: 'black', color: 'var(--terminal-amber)', border: '1px solid var(--terminal-amber)', padding: '5px' }}
                    >
                    ...
                    <button className="mode-btn theme-amber" style={{ fontSize: '0.6rem' }} onClick={handleGenerateRandomPilot}>[ GENERATE ]</button>
                </div>
            </div>

            {generatedLink && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', marginTop: '10px', borderTop: '1px solid rgba(255,255,0,0.2)', paddingTop: '10px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '10px' }}>
                        <input
                            ...
                            readOnly
                            value={generatedLink}
                            style={{ flex: 1, backgroundColor: 'black', color: 'var(--terminal-amber)', border: '1px solid var(--terminal-amber)', padding: '5px', fontSize: '0.7rem' }}
                        />
                        <button className="mode-btn theme-amber" style={{ fontSize: '0.6rem' }} onClick={copyToClipboard}>[ COPY ]</button>
                    </div>
                </div>
            )}
        </div>
