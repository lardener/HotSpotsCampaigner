...
import type {
  ...
  Detachment,
  Pilot,
  ResolvedStepValues as GeneratedResolvedStepValues,
  Query,
} from './generated'
import type {
  GetMyCommandsQuery,
  GetManagedCampaignsQuery,
 ...
 */
export type ActiveCampaignSummary = Pick<
  Campaign,
  | 'id'
  | 'name'
  | 'systemName'
 ...
 */
export type PublicCampaignMetadataWithRules = PublicCampaignMetadataMinimal &
  Pick<
    CampaignMetadata,
    | 'missions'
    | 'trackTypes'
 ...
 */
export type CampaignDetailSummary = Pick<
  Campaign,
  | 'id'
  | 'name'
  | 'status'
