...
export type AutoJoinCampaignMutationVariables = Exact<{
  campaignId: string
  detachmentId: string
}>

export type AutoJoinCampaignMutation = { autoJoinCampaign: boolean | null }

export type CancelJoinCampaignMutationVariables = Exact<{
  token: string
}>

export type CancelJoinCampaignMutation = { cancelJoinCampaign: boolean | null }
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'mixedTechModifier' } },
                { kind: 'Field', name: { kind: 'Name', value: 'clanTechModifier' } },
                { kind: 'Field', name: { kind: 'Name', value: 'omnimechReconfigureModifier' } },
                { kind: 'Field', name: { kind: 'Name', value: 'pvPurchaseUnitMultiplier' } },
                { kind: 'Field', name: { kind: 'Name', value: 'pvSellUnitMultiplier' } },
                { kind: 'Field', name: { kind: 'Name', value: 'rearmCostPerTon' } },
                { kind: 'Field', name: { kind: 'Name', value: 'rearmCostPerTonAlphaStrike' } },
                { kind: 'Field', name: { kind: 'Name', value: 'hireMechWarriorCost' } },
                { kind: 'Field', name: { kind: 'Name', value: 'hireNamedPilotCost' } },
                { kind: 'Field', name: { kind: 'Name', value: 'hireBattleArmorCost' } },
                { kind: 'Field', name: { kind: 'Name', value: 'healMechWarriorPerWoundBoxCost' } },
                { kind: 'Field', name: { kind: 'Name', value: 'healMechWarriorPerMonthLimit' } },
                { kind: 'Field', name: { kind: 'Name', value: 'healBattleArmorCost' } },
                { kind: 'Field', name: { kind: 'Name', value: 'trainFormationCommanderCost' } },
                { kind: 'Field', name: { kind: 'Name', value: 'changeFormationTrainingCost' } },
                { kind: 'Field', name: { kind: 'Name', value: 'learnCommandAbility1Cost' } },
                { kind: 'Field', name: { kind: 'Name', value: 'learnCommandAbility2Cost' } },
                { kind: 'Field', name: { kind: 'Name', value: 'learnCommandAbility3Cost' } },
                { kind: 'Field', name: { kind: 'Name', value: 'replaceCommandAbilityCost' } },
...
export const AutoJoinCampaignDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'AutoJoinCampaign' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'campaignId' } },
...
} as unknown as DocumentNode<AutoJoinCampaignMutation, AutoJoinCampaignMutationVariables>
export const CancelJoinCampaignDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CancelJoinCampaign' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'token' } },
...
} as unknown as DocumentNode<CancelJoinCampaignMutation, CancelJoinCampaignMutationVariables>
