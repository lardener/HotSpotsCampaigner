...
@ Service 
    ...
    public class MercenaryCommandService {
        ...
        /**
         * Establishes a new mercenary command. Modeled on the initial setup of
         * the Mercenary Force Record Sheet.
         */
        @Transactional
        ...
        /**
         * Creates a new detachment for a command assigned to a specific
         * campaign theater.
         */
        @Transactional
         ...
         * summing all ledger entries across all its detachments. This ensures
         * the Command state matches the "MERCENARY CONTRACT RECORD SHEET"
         * history.
         */
        @Transactional
        ...
        /**
         * Assigns a unit or pilot to a detachment. Ensures the asset is not
